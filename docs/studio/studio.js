 ...
 *
 * Only ever runs once the engine is already in memory. Typing a name must not trigger a
 * 9 MB download nobody asked for, so the first fill stays behind the button; from then on
 * it is a ~250 ms local call and can happen freely.
 *
